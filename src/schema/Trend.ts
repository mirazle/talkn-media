// To parse this data:
//
//   import { Convert, Trend } from "./file";
//
//   const news = Convert.toTrend(json);
//
...
export class Convert {
    public static toTrend(json: string): Trend {
        return cast(JSON.parse(json), r("Trend"));
    }

    public static newsToJson(value: Trend): string {
        return JSON.stringify(uncast(value, r("Trend")), null, 2);
    }
}
